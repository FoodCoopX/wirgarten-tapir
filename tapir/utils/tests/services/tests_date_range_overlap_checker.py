...
class TestsDateRangeOverlapChecker(SimpleTestCase):
    ...
    def test_getNumberOfDaysOfOverlap_range1IsCompletelyBeforeRange2_returnsFalse(self):
        self.assertEqual(
            0,
    ...
    def test_getNumberOfDaysOfOverlap_range2IsCompletelyBeforeRange1_returnsFalse(self):
        self.assertEqual(
            0,
            DateRangeOverlapChecker.get_number_of_days_of_overlap(
                range_1_start=datetime.date(year=2024, month=5, day=23),
    ...
    def test_getNumberOfDaysOfOverlap_range1OverlapsBeginningOfRange2_returnsTrue(self):
        self.assertEqual(
            3,
            DateRangeOverlapChecker.get_number_of_days_of_overlap(
                range_1_start=datetime.date(year=2024, month=5, day=23),
                range_1_end=datetime.date(year=2025, month=1, day=3),
                range_2_start=datetime.date(year=2025, month=1, day=1),
                range_2_end=datetime.date(year=2025, month=1, day=15),
            ),
        )

    def test_getNumberOfDaysOfOverlap_range1OverlapsEndOfRange2_returnsTrue(self):
        self.assertEqual(
            3,
            DateRangeOverlapChecker.get_number_of_days_of_overlap(
                range_1_start=datetime.date(year=2025, month=1, day=1),
    ...
    def test_getNumberOfDaysOfOverlap_range1IsInsideRange2_returnsTrue(self):
        self.assertEqual(
            11,
            DateRangeOverlapChecker.get_number_of_days_of_overlap(
                range_1_start=datetime.date(year=2025, month=3, day=4),
                range_1_end=datetime.date(year=2025, month=3, day=14),
                range_2_start=datetime.date(year=2025, month=3, day=1),
                range_2_end=datetime.date(year=2025, month=4, day=20),
            ),
        )

    def test_getNumberOfDaysOfOverlap_range2IsInsideRange1_returnsTrue(self):
        self.assertEqual(
            7,
            DateRangeOverlapChecker.get_number_of_days_of_overlap(
                range_1_start=datetime.date(year=2025, month=3, day=1),
