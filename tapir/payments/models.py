...
class MemberCredit(TapirModel):
    ...
    accounted_on = models.DateTimeField(null=True, blank=True, default=None)
...
class MemberCreditAccountedLogEntry(ModelLogEntry):
    template_name = "payments/log/member_credit_accounted_log_entry.html"
