...
class MonthlySalesSegmentProvider:
    ...
    def get_list_monthly_sales(
        ...
        range_start = reference_datetime.date().replace(day=1)
        range_end = get_last_day_of_month(reference_datetime.date())
