...
class PaymentExportBuilder:
    ...
    def should_export_payments(
        ...
        payment_type_display = cls.get_payment_type_display_legacy(is_contract_payments)
        last_transaction = (
    ...
    def create_and_assign_transaction(
        ...
        payment_transaction = PaymentTransaction.objects.create(
            file=file,
            type=cls.get_payment_type_display_legacy(is_contract_payments),
    ...
    def export_payments(
        ...
        for payment in payments:
            intended_use = cls.build_intended_use(
        ...
        return export_file(
            filename=f"{cls.get_payment_type_display_legacy(contract_payments)}-Einzahlungen",
    ...
    def build_intended_use(cls, payment: Payment, is_contracts: bool, cache: dict):
        if get_parameter_value(
            ...
            return cls.build_intended_use_from_pattern(
                payment=payment, is_contracts=is_contracts, cache=cache
            )

        return cls.build_intended_use_legacy(
            is_contracts=is_contracts, payment=payment, cache=cache
        )

    @classmethod
    def build_intended_use_legacy(
    ...
    @classmethod
    def build_intended_use_from_pattern(
        cls, payment: Payment, is_contracts: bool, cache: dict
    ):
        if is_contracts:
