...
class TestExportCoopMemberList(TapirIntegrationTest):
    # The export_coop_member_list is legacy code, I chose not to take the time to test it fully.
    ...
    def test_exportCoopMemberList_legalStatusIsAssociation_returns200(self):
        ...
        response = self.client.get(reverse("wirgarten:member_list_coop_export"))

        self.assertStatusCode(response, status.HTTP_200_OK)

    def test_exportCoopMemberList_legalStatusIsCooperative_returns200(self):
        self.client.force_login(MemberFactory.create(is_superuser=True))
        self._set_parameter(
    ...
    def test_exportCoopMemberList_legalStatusIsCompany_returns200(self):
        self.client.force_login(MemberFactory.create(is_superuser=True))
        self._set_parameter(
