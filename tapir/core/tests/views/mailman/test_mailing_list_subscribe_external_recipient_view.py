...
class TestMailingListSubscribeExternalRecipientView(TapirIntegrationTest):
    @classmethod
    ...
    def test_post_loggedInAsNormalMember_returns403(self):
        ...
        response = self.client.post(
            reverse("core:mailing_list_subscribe_external"), data=post_data
        )
    ...
    def test_post_default_callsSubscribe(self):
        ...
        mailing_list_b.subscribe.assert_called_once_with(
            address="external@example.com", invitation=True
        )
