...
class TemplateBasketTotalsByRouteBiotop:
    ID = "basket_totals_by_route_biotop"
    ...
    def create_exports(cls):
        ...
        with open(
            "tapir/generic_exports/services/pdf_templates/basket_totals_by_route_biotop.html",
            "r",
        ) as file:
