...
export const BreadContentsModal: React.FC<BreadContentsModalProps> = ({
  bread,
  csrfToken,
  onClose,
}) => {
          ...
          <>
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      ...
                      {availableIngredients
                        .filter(
                          (ing) =>
                            !contents.some((c) => c.ingredient === ing.id),
                        )
                        .map((ingredient) => (
            ...
            {contents.length > 0 && (
              <div className="mt-3 text-end">
                <strong>
                  Summe:{" "}
                  {contents.reduce((sum, c) => sum + Number(c.amount), 0)}g
                </strong>
              </div>
            )}
          </>
