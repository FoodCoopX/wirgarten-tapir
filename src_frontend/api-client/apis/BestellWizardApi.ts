...
export class BestellWizardApi extends runtime.BaseAPI {
    ...
    /**
     */
    async bestellWizardApiBestellWizardBaseDataRetrieveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BestellWizardBaseDataResponse>> {
    ...
    /**
     */
    async bestellWizardApiBestellWizardBaseDataRetrieve(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BestellWizardBaseDataResponse> {
        const response = await this.bestellWizardApiBestellWizardBaseDataRetrieveRaw(initOverrides);
        return await response.value();
    }

    /**
     */
    async bestellWizardApiBestellWizardCapacityCheckCreateRaw(requestParameters: BestellWizardApiBestellWizardCapacityCheckCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BestellWizardCapacityCheckResponse>> {
    ...
    /**
     */
    async bestellWizardApiBestellWizardCapacityCheckCreate(requestParameters: BestellWizardApiBestellWizardCapacityCheckCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BestellWizardCapacityCheckResponse> {
        const response = await this.bestellWizardApiBestellWizardCapacityCheckCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async bestellWizardApiBestellWizardDeliveryDatesCreateRaw(requestParameters: BestellWizardApiBestellWizardDeliveryDatesCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BestellWizardDeliveryDatesForOrderResponse>> {
    ...
    /**
     */
    async bestellWizardApiBestellWizardDeliveryDatesCreate(requestParameters: BestellWizardApiBestellWizardDeliveryDatesCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BestellWizardDeliveryDatesForOrderResponse> {
        const response = await this.bestellWizardApiBestellWizardDeliveryDatesCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async bestellWizardBestellWizardConfirmOrderCreateRaw(requestParameters: BestellWizardBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
    ...
    /**
     */
    async bestellWizardBestellWizardConfirmOrderCreate(requestParameters: BestellWizardBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.bestellWizardBestellWizardConfirmOrderCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
