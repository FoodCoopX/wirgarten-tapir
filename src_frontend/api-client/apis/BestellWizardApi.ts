...
export class BestellWizardApi extends runtime.BaseAPI {
  ...
  /**
   */
  async bestellWizardApiContractStartDateWaitingListEntryRetrieveRaw(
    requestParameters: BestellWizardApiContractStartDateWaitingListEntryRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async bestellWizardApiContractStartDateWaitingListEntryRetrieve(
    requestParameters: BestellWizardApiContractStartDateWaitingListEntryRetrieveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Date> {
    const response =
      await this.bestellWizardApiContractStartDateWaitingListEntryRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  /**
   */
  async bestellWizardApiEarliestContractStartDateRetrieveRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Date>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async bestellWizardApiEarliestContractStartDateRetrieve(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Date> {
    const response =
      await this.bestellWizardApiEarliestContractStartDateRetrieveRaw(
        initOverrides,
      );
    return await response.value();
  }
  ...
  /**
   */
  async bestellWizardApiProductPricesRetrieveRaw(
    requestParameters: BestellWizardApiProductPricesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PublicProductPricesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PublicProductPricesResponseFromJSON(jsonValue),
    );
  }

  /**
   */
  async bestellWizardApiProductPricesRetrieve(
    requestParameters: BestellWizardApiProductPricesRetrieveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PublicProductPricesResponse> {
    const response = await this.bestellWizardApiProductPricesRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
