...
export class SubscriptionsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async subscriptionsBestellWizardConfirmOrderCreateRaw(requestParameters: SubscriptionsBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BestellWizardConfirmOrderResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => BestellWizardConfirmOrderResponseFromJSON(jsonValue));
    }

    /**
     */
    async subscriptionsBestellWizardConfirmOrderCreate(requestParameters: SubscriptionsBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BestellWizardConfirmOrderResponse> {
