...
export class SubscriptionsApi extends runtime.BaseAPI {
  ...
  /**
   */
  async subscriptionsApiNextContractStartDateRetrieveRaw(
    requestParameters: SubscriptionsApiNextContractStartDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async subscriptionsApiNextContractStartDateRetrieve(
    requestParameters: SubscriptionsApiNextContractStartDateRetrieveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Date> {
    const response =
      await this.subscriptionsApiNextContractStartDateRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
