...
export class SubscriptionsApi extends runtime.BaseAPI {
  ...
  /**
   */
  async subscriptionsProductTypesListRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ProductType>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ProductTypeFromJSON),
    );
  }

  /**
   */
  async subscriptionsProductTypesList(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async subscriptionsProductTypesRetrieveRaw(
    requestParameters: SubscriptionsProductTypesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProductType>> {
    ...
    const response = await this.request(
      {
        path: `/subscriptions/product_types/{id}/`.replace(
          `{${"id"}}`,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProductTypeFromJSON(jsonValue),
    );
  }

  /**
   */
  async subscriptionsProductTypesRetrieve(
    requestParameters: SubscriptionsProductTypesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ProductType> {
    const response = await this.subscriptionsProductTypesRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
