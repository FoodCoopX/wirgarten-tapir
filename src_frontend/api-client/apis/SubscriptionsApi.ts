...
export interface SubscriptionsProductTypesRetrieveRequest {
    id: string;
}
...
export class SubscriptionsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async subscriptionsProductTypesListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ProductType>>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};

        const response = await this.request({
            path: `/subscriptions/product_types/`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async subscriptionsProductTypesList(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ProductType>> {
        const response = await this.subscriptionsProductTypesListRaw(initOverrides);
        return await response.value();
    }

    /**
     */
    async subscriptionsProductTypesRetrieveRaw(requestParameters: SubscriptionsProductTypesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProductType>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling subscriptionsProductTypesRetrieve().'
            );
        }
        ...
        const response = await this.request({
            path: `/subscriptions/product_types/{id}/`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async subscriptionsProductTypesRetrieve(requestParameters: SubscriptionsProductTypesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProductType> {
        const response = await this.subscriptionsProductTypesRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
