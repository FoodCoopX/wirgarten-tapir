...
export interface SubscriptionsApiNextContractStartDateRetrieveRequest {
...
export class SubscriptionsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async subscriptionsApiIsEmailAddressValidRetrieveRaw(requestParameters: SubscriptionsApiIsEmailAddressValidRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async subscriptionsApiIsEmailAddressValidRetrieve(requestParameters: SubscriptionsApiIsEmailAddressValidRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean> {
        const response = await this.subscriptionsApiIsEmailAddressValidRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async subscriptionsApiNextContractStartDateRetrieveRaw(requestParameters: SubscriptionsApiNextContractStartDateRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Date>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/subscriptions/api/next_contract_start_date`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async subscriptionsApiNextContractStartDateRetrieve(requestParameters: SubscriptionsApiNextContractStartDateRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Date> {
        const response = await this.subscriptionsApiNextContractStartDateRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async subscriptionsBestellWizardConfirmOrderCreateRaw(requestParameters: SubscriptionsBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BestellWizardConfirmOrderRequestRequestToJSON(requestParameters['bestellWizardConfirmOrderRequestRequest']),
        }, initOverrides);
    ...
    /**
     */
    async subscriptionsBestellWizardConfirmOrderCreate(requestParameters: SubscriptionsBestellWizardConfirmOrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.subscriptionsBestellWizardConfirmOrderCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
