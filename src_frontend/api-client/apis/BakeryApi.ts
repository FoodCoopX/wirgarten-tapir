...
export class BakeryApi extends runtime.BaseAPI {
   ...
   */
  async bakeryApiBakerySolverApplyCreateRaw(
    requestParameters: BakeryApiBakerySolverApplyCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SolverApplyResponse>> {
    ...
    const response = await this.request(
      {
        ...
        body: SolverApplyRequestRequestToJSON(
          requestParameters["solverApplyRequestRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SolverApplyResponseFromJSON(jsonValue),
    );
  }
   ...
   * Apply a cached solver solution to the database
   */
  async bakeryApiBakerySolverApplyCreate(
    requestParameters: BakeryApiBakerySolverApplyCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SolverApplyResponse> {
    const response = await this.bakeryApiBakerySolverApplyCreateRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async bakeryApiBakerySolverPreviewCreateRaw(
    requestParameters: BakeryApiBakerySolverPreviewCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SolverPreviewResponse>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SolverPreviewRequestRequestToJSON(
          requestParameters["solverPreviewRequestRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SolverPreviewResponseFromJSON(jsonValue),
    );
  }
   ...
   * Run solver and preview multiple solutions
   */
  async bakeryApiBakerySolverPreviewCreate(
    requestParameters: BakeryApiBakerySolverPreviewCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SolverPreviewResponse> {
    const response = await this.bakeryApiBakerySolverPreviewCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryApiBakerySolverPreviewDetailRetrieveRaw(
    requestParameters: BakeryApiBakerySolverPreviewDetailRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SolverPreviewDetailResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SolverPreviewDetailResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get full details of a cached solver solution
   */
  async bakeryApiBakerySolverPreviewDetailRetrieve(
    requestParameters: BakeryApiBakerySolverPreviewDetailRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SolverPreviewDetailResponse> {
    const response = await this.bakeryApiBakerySolverPreviewDetailRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryApiPreferredBreadStatisticsRetrieveRaw(
    requestParameters: BakeryApiPreferredBreadStatisticsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PreferredBreadStatistics>> {
    if (requestParameters["deliveryWeek"] == null) {
      throw new runtime.RequiredError(
        "deliveryWeek",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PreferredBreadStatisticsFromJSON(jsonValue),
    );
  }
   ...
   * Count preferred breads among members with active deliveries for the given week.
   */
  async bakeryApiPreferredBreadStatisticsRetrieve(
    requestParameters: BakeryApiPreferredBreadStatisticsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PreferredBreadStatistics> {
    const response = await this.bakeryApiPreferredBreadStatisticsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryAvailableBreadsForDeliveryCreateRaw(
    requestParameters: BakeryAvailableBreadsForDeliveryCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ToggleBreadResponse>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: ToggleBreadRequestRequestToJSON(
          requestParameters["toggleBreadRequestRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ToggleBreadResponseFromJSON(jsonValue),
    );
  }
   ...
   * Toggle bread availability for a delivery day
   */
  async bakeryAvailableBreadsForDeliveryCreate(
    requestParameters: BakeryAvailableBreadsForDeliveryCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ToggleBreadResponse> {
    const response = await this.bakeryAvailableBreadsForDeliveryCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryAvailableBreadsForDeliveryRetrieveRaw(
    requestParameters: BakeryAvailableBreadsForDeliveryRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AvailableBreadsForDeliveryListResponse>> {
    if (requestParameters["deliveryDay"] == null) {
      throw new runtime.RequiredError(
        "deliveryDay",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AvailableBreadsForDeliveryListResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get breads for a delivery day
   */
  async bakeryAvailableBreadsForDeliveryRetrieve(
    requestParameters: BakeryAvailableBreadsForDeliveryRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AvailableBreadsForDeliveryListResponse> {
    const response = await this.bakeryAvailableBreadsForDeliveryRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadDeliveriesListRaw(
    requestParameters: BakeryBreadDeliveriesListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadDelivery>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadDeliveryFromJSON),
    );
  }
   ...
   * A member\'s bread slots: one per delivered week per share.
   */
  async bakeryBreadDeliveriesList(
    requestParameters: BakeryBreadDeliveriesListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<BreadDelivery>> {
    const response = await this.bakeryBreadDeliveriesListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadDeliveriesPartialUpdateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadDelivery>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/bakery/bread-deliveries/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "PATCH",
        headers: headerParameters,
        query: queryParameters,
        body: PatchedBreadDeliveryRequestToJSON(
          requestParameters["patchedBreadDeliveryRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BreadDeliveryFromJSON(jsonValue),
    );
  }
  ...
  async bakeryBreadDeliveriesPartialUpdate(
    requestParameters: BakeryBreadDeliveriesPartialUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<BreadDelivery> {
    const response = await this.bakeryBreadDeliveriesPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * A member\'s bread slots: one per delivered week per share.
   */
  async bakeryBreadDeliveriesRetrieveRaw(
    requestParameters: BakeryBreadDeliveriesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadDelivery>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * A member\'s bread slots: one per delivered week per share.
   */
  async bakeryBreadDeliveriesRetrieve(
    requestParameters: BakeryBreadDeliveriesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<BreadDelivery> {
    const response = await this.bakeryBreadDeliveriesRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadSpecificsBulkUpdateCreateRaw(
    requestParameters: BakeryBreadSpecificsBulkUpdateCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters["breadSpecificsPerDeliveryDayBulkUpdateRequest"] == null
    ) {
      throw new runtime.RequiredError(
        "breadSpecificsPerDeliveryDayBulkUpdateRequest",
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: BreadSpecificsPerDeliveryDayBulkUpdateRequestToJSON(
          requestParameters["breadSpecificsPerDeliveryDayBulkUpdateRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryBreadSpecificsBulkUpdateCreate(
    ...
    await this.bakeryBreadSpecificsBulkUpdateCreateRaw(
      requestParameters,
      initOverrides,
    );
  }
  ...
  async bakeryBreadSpecificsCreateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadSpecificsPerDeliveryDay>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: BreadSpecificsPerDeliveryDayRequestToJSON(
          requestParameters["breadSpecificsPerDeliveryDayRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BreadSpecificsPerDeliveryDayFromJSON(jsonValue),
    );
  }
  ...
  async bakeryBreadSpecificsCreate(
    requestParameters: BakeryBreadSpecificsCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<BreadSpecificsPerDeliveryDay> {
    const response = await this.bakeryBreadSpecificsCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadSpecificsDestroyRaw(
    ...
    const response = await this.request(
      {
        path: `/bakery/bread-specifics/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "DELETE",
  ...
  async bakeryBreadSpecificsListRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadSpecificsPerDeliveryDay>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadSpecificsPerDeliveryDayFromJSON),
    );
  }
  ...
  async bakeryBreadSpecificsList(
    requestParameters: BakeryBreadSpecificsListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<BreadSpecificsPerDeliveryDay>> {
    const response = await this.bakeryBreadSpecificsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchedBreadSpecificsPerDeliveryDayRequestToJSON(
          requestParameters["patchedBreadSpecificsPerDeliveryDayRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryBreadSpecificsPartialUpdate(
    ...
    const response = await this.bakeryBreadSpecificsPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadSpecificsRetrieve(
    ...
    const response = await this.bakeryBreadSpecificsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadSpecificsUpdate(
    ...
    const response = await this.bakeryBreadSpecificsUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadcontentsCreateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadContent>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: BreadContentRequestToJSON(
          requestParameters["breadContentRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BreadContentFromJSON(jsonValue),
    );
  }
  ...
  async bakeryBreadcontentsCreate(
    requestParameters: BakeryBreadcontentsCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<BreadContent> {
    const response = await this.bakeryBreadcontentsCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadcontentsDestroyRaw(
    ...
    const response = await this.request(
      {
        path: `/bakery/breadcontents/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "DELETE",
  ...
  async bakeryBreadcontentsListRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadContent>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadContentFromJSON),
    );
  }
  ...
  async bakeryBreadcontentsList(
    requestParameters: BakeryBreadcontentsListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<BreadContent>> {
    const response = await this.bakeryBreadcontentsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchedBreadContentRequestToJSON(
          requestParameters["patchedBreadContentRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryBreadcontentsPartialUpdate(
    ...
    const response = await this.bakeryBreadcontentsPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadcontentsRetrieve(
    ...
    const response = await this.bakeryBreadcontentsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadcontentsUpdate(
    ...
    const response = await this.bakeryBreadcontentsUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListByLabelsListRaw(
    requestParameters: BakeryBreadsListByLabelsListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadList>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadListFromJSON),
    );
  }
  ...
  async bakeryBreadsListByLabelsList(
    requestParameters: BakeryBreadsListByLabelsListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<BreadList>> {
    const response = await this.bakeryBreadsListByLabelsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListContentsCreateRaw(
    requestParameters: BakeryBreadsListContentsCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadContent>>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/bakery/breads-list/{id}/contents/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "POST",
  ...
  async bakeryBreadsListContentsCreate(
    ...
    const response = await this.bakeryBreadsListContentsCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListContentsListRaw(
    requestParameters: BakeryBreadsListContentsListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadContent>>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  async bakeryBreadsListContentsList(
    ...
    const response = await this.bakeryBreadsListContentsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListCreateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadList>> {
    if (requestParameters["breadListRequest"] == null) {
      throw new runtime.RequiredError(
        "breadListRequest",
  ...
  async bakeryBreadsListCreate(
    ...
    const response = await this.bakeryBreadsListCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListDestroyRaw(
    ...
    const response = await this.request(
      {
        path: `/bakery/breads-list/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "DELETE",
  ...
  async bakeryBreadsListList(
    ...
    const response = await this.bakeryBreadsListListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchedBreadListRequestToJSON(
          requestParameters["patchedBreadListRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryBreadsListPartialUpdate(
    ...
    const response = await this.bakeryBreadsListPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListRetrieveRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadDetail>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
  ...
  async bakeryBreadsListRetrieve(
    ...
    const response = await this.bakeryBreadsListRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsListUpdate(
    ...
    const response = await this.bakeryBreadsListUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsPerPickupLocationPerWeekListRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadsPerPickupLocationPerWeek>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadsPerPickupLocationPerWeekFromJSON),
    );
  }
  ...
  async bakeryBreadsPerPickupLocationPerWeekList(
    requestParameters: BakeryBreadsPerPickupLocationPerWeekListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<BreadsPerPickupLocationPerWeek>> {
    const response = await this.bakeryBreadsPerPickupLocationPerWeekListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryBreadsPerPickupLocationPerWeekRetrieveRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadsPerPickupLocationPerWeek>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/bakery/breads-per-pickup-location-per-week/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BreadsPerPickupLocationPerWeekFromJSON(jsonValue),
    );
  }
  ...
  async bakeryBreadsPerPickupLocationPerWeekRetrieve(
    requestParameters: BakeryBreadsPerPickupLocationPerWeekRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<BreadsPerPickupLocationPerWeek> {
    const response = await this.bakeryBreadsPerPickupLocationPerWeekRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryIngredientsCreateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Ingredient>> {
  ...
  async bakeryIngredientsCreate(
    ...
    const response = await this.bakeryIngredientsCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryIngredientsDestroyRaw(
    ...
    const response = await this.request(
      {
        path: `/bakery/ingredients/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "DELETE",
  ...
  async bakeryIngredientsListRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<Ingredient>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(IngredientFromJSON),
    );
  }
  ...
  async bakeryIngredientsList(
    ...
    const response = await this.bakeryIngredientsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchedIngredientRequestToJSON(
          requestParameters["patchedIngredientRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryIngredientsPartialUpdate(
    ...
    const response = await this.bakeryIngredientsPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryIngredientsRetrieve(
    ...
    const response = await this.bakeryIngredientsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryIngredientsUpdate(
    ...
    const response = await this.bakeryIngredientsUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryLabelsCreateRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BreadLabel>> {
  ...
  async bakeryLabelsCreate(
    ...
    const response = await this.bakeryLabelsCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryLabelsListRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<BreadLabel>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BreadLabelFromJSON),
    );
  }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchedBreadLabelRequestToJSON(
          requestParameters["patchedBreadLabelRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async bakeryLabelsPartialUpdate(
    ...
    const response = await this.bakeryLabelsPartialUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryLabelsRetrieve(
    ...
    const response = await this.bakeryLabelsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryLabelsUpdate(
    ...
    const response = await this.bakeryLabelsUpdateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryMetricsSatisfactionRetrieveRaw(
    requestParameters: BakeryMetricsSatisfactionRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PreferenceSatisfactionResponse>> {
    if (requestParameters["deliveryWeek"] == null) {
      throw new runtime.RequiredError(
        "deliveryWeek",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PreferenceSatisfactionResponseFromJSON(jsonValue),
    );
  }
   ...
   * Calculate preference satisfaction metrics for a given week. Simulates pickup: members choose their first available favorite bread.
   */
  async bakeryMetricsSatisfactionRetrieve(
    requestParameters: BakeryMetricsSatisfactionRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PreferenceSatisfactionResponse> {
    const response = await this.bakeryMetricsSatisfactionRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryPickupListRetrieveRaw(
    requestParameters: BakeryPickupListRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PickupListsResponse>> {
    if (requestParameters["deliveryWeek"] == null) {
      throw new runtime.RequiredError(
        "deliveryWeek",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PickupListsResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get pickup list for a specific pickup location
   */
  async bakeryPickupListRetrieve(
    requestParameters: BakeryPickupListRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PickupListsResponse> {
    const response = await this.bakeryPickupListRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryPreferredBreadsBulkUpdateCreateRaw(
    requestParameters: BakeryPreferredBreadsBulkUpdateCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PreferredBreadsBulkUpdate>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/bakery/preferred-breads/{id}/bulk-update/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "POST",
        headers: headerParameters,
        query: queryParameters,
        body: PreferredBreadsBulkUpdateRequestToJSON(
          requestParameters["preferredBreadsBulkUpdateRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PreferredBreadsBulkUpdateFromJSON(jsonValue),
    );
  }
   ...
   * Bulk update preferred breads for a member. Replaces all breads for the member with the provided list.
   */
  async bakeryPreferredBreadsBulkUpdateCreate(
    requestParameters: BakeryPreferredBreadsBulkUpdateCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PreferredBreadsBulkUpdate> {
    const response = await this.bakeryPreferredBreadsBulkUpdateCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async bakeryPreferredBreadsListRaw(
    requestParameters: BakeryPreferredBreadsListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<PreferredBread>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(PreferredBreadFromJSON),
    );
  }
   ...
   * Read preferred breads for a member.
   */
  async bakeryPreferredBreadsList(
    requestParameters: BakeryPreferredBreadsListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<PreferredBread>> {
    const response = await this.bakeryPreferredBreadsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Read preferred breads for a member.
   */
  async bakeryPreferredBreadsRetrieveRaw(
    requestParameters: BakeryPreferredBreadsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PreferredBread>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/bakery/preferred-breads/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PreferredBreadFromJSON(jsonValue),
    );
  }
   ...
   * Read preferred breads for a member.
   */
  async bakeryPreferredBreadsRetrieve(
    requestParameters: BakeryPreferredBreadsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PreferredBread> {
    const response = await this.bakeryPreferredBreadsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryStoveSessionsListRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<StoveSession>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(StoveSessionFromJSON),
    );
  }
  ...
  async bakeryStoveSessionsList(
    requestParameters: BakeryStoveSessionsListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<StoveSession>> {
    const response = await this.bakeryStoveSessionsListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async bakeryStoveSessionsRetrieveRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<StoveSession>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/bakery/stove-sessions/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StoveSessionFromJSON(jsonValue),
    );
  }
  ...
  async bakeryStoveSessionsRetrieve(
    requestParameters: BakeryStoveSessionsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<StoveSession> {
    const response = await this.bakeryStoveSessionsRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
