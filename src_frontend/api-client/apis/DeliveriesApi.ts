...
export class DeliveriesApi extends runtime.BaseAPI {
  /**
   */
  async deliveriesApiCancelDonationCreateRaw(
    requestParameters: DeliveriesApiCancelDonationCreateRequest,
  ...
  /**
   */
  async deliveriesApiCancelDonationCreate(
    requestParameters: DeliveriesApiCancelDonationCreateRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.deliveriesApiCancelDonationCreateRaw(
      requestParameters,
      initOverrides,
    );
  ...
  /**
   */
  async deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRaw(
    requestParameters: DeliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<GetDatesFromCustomCycleDeliveryWeeksResponse>
  > {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CustomCycleDeliveryWeeksRequestToJSON(
          requestParameters["customCycleDeliveryWeeksRequest"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetDatesFromCustomCycleDeliveryWeeksResponseFromJSON(jsonValue),
    );
  }

  /**
   */
  async deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreate(
    requestParameters: DeliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetDatesFromCustomCycleDeliveryWeeksResponse> {
    const response =
      await this.deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  /**
   */
  async deliveriesApiUseDonationCreateRaw(
    requestParameters: DeliveriesApiUseDonationCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async deliveriesApiUseDonationCreate(
    requestParameters: DeliveriesApiUseDonationCreateRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.deliveriesApiUseDonationCreateRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
