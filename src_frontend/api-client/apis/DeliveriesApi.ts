...
import {
    CustomCycleDeliveryWeeksRequestFromJSON,
    CustomCycleDeliveryWeeksRequestToJSON,
    DeliveryFromJSON,
    DeliveryToJSON,
    GetDatesFromCustomCycleDeliveryWeeksResponseFromJSON,
    GetDatesFromCustomCycleDeliveryWeeksResponseToJSON,
    ...
    PatchedGrowingPeriodWithDeliveryDayAdjustmentsRequestFromJSON,
...
export interface DeliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRequest {
    customCycleDeliveryWeeksRequest: CustomCycleDeliveryWeeksRequest;
}
...
export class DeliveriesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRaw(requestParameters: DeliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetDatesFromCustomCycleDeliveryWeeksResponse>> {
        if (requestParameters['customCycleDeliveryWeeksRequest'] == null) {
            throw new runtime.RequiredError(
                'customCycleDeliveryWeeksRequest',
                'Required parameter "customCycleDeliveryWeeksRequest" was null or undefined when calling deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreate().'
            );
        }
        ...
        const response = await this.request({
            path: `/deliveries/api/get_dates_from_custom_cycle_delivery_weeks`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CustomCycleDeliveryWeeksRequestToJSON(requestParameters['customCycleDeliveryWeeksRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetDatesFromCustomCycleDeliveryWeeksResponseFromJSON(jsonValue));
    }

    /**
     */
    async deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreate(requestParameters: DeliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetDatesFromCustomCycleDeliveryWeeksResponse> {
        const response = await this.deliveriesApiGetDatesFromCustomCycleDeliveryWeeksCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async deliveriesApiGrowingPeriodWithAdjustmentsPartialUpdateRaw(requestParameters: DeliveriesApiGrowingPeriodWithAdjustmentsPartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PatchedGrowingPeriodWithDeliveryDayAdjustmentsRequestToJSON(requestParameters['patchedGrowingPeriodWithDeliveryDayAdjustmentsRequest']),
        }, initOverrides);
    ...
    /**
     */
    async deliveriesApiGrowingPeriodWithAdjustmentsPartialUpdate(requestParameters: DeliveriesApiGrowingPeriodWithAdjustmentsPartialUpdateRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.deliveriesApiGrowingPeriodWithAdjustmentsPartialUpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }
