...
import {
    ...
    ProductTypesAndConfigToJSON,
    SaveExtendedProductTypeRequestFromJSON,
...
export class ProductsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async productsApiExtendedProductTypeCreateRaw(requestParameters: ProductsApiExtendedProductTypeCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        ...
        const response = await this.request({
            ...
            body: SaveExtendedProductTypeRequestToJSON(requestParameters['saveExtendedProductTypeRequest']),
        }, initOverrides);
    ...
    /**
     */
    async productsApiExtendedProductTypeCreate(requestParameters: ProductsApiExtendedProductTypeCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.productsApiExtendedProductTypeCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async productsApiExtendedProductTypePartialUpdateRaw(requestParameters: ProductsApiExtendedProductTypePartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async productsApiExtendedProductTypePartialUpdate(requestParameters: ProductsApiExtendedProductTypePartialUpdateRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
    ...
    /**
     */
    async productsApiProductTypesWithoutCapacityRetrieveRaw(requestParameters: ProductsApiProductTypesWithoutCapacityRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProductTypesAndConfig>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ProductTypesAndConfigFromJSON(jsonValue));
    }

    /**
     */
    async productsApiProductTypesWithoutCapacityRetrieve(requestParameters: ProductsApiProductTypesWithoutCapacityRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProductTypesAndConfig> {
        const response = await this.productsApiProductTypesWithoutCapacityRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
