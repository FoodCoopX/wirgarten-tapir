...
export class WaitingListApi extends runtime.BaseAPI {
  ...
  /**
   */
  async waitingListApiMemberWaitingListEntryDetailsRetrieveRaw(
    requestParameters: WaitingListApiMemberWaitingListEntryDetailsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OptionalWaitingListEntryDetails>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      OptionalWaitingListEntryDetailsFromJSON(jsonValue),
    );
  }

  /**
   */
  async waitingListApiMemberWaitingListEntryDetailsRetrieve(
    requestParameters: WaitingListApiMemberWaitingListEntryDetailsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OptionalWaitingListEntryDetails> {
    const response =
      await this.waitingListApiMemberWaitingListEntryDetailsRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async waitingListApiPublicGetWaitingListEntryDetailsRetrieveRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PublicWaitingListEntryDetails>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PublicWaitingListEntryDetailsFromJSON(jsonValue),
    );
  }
  ...
  async waitingListApiPublicGetWaitingListEntryDetailsRetrieve(
    requestParameters: WaitingListApiPublicGetWaitingListEntryDetailsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PublicWaitingListEntryDetails> {
    const response =
  ...
  /**
   */
  async waitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRaw(
    requestParameters: WaitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
    if (
  ...
  /**
   */
  async waitingListApiPublicWaitingListCreateEntryPotentialMemberCreate(
    requestParameters: WaitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrderConfirmationResponse> {
    const response =
      await this.waitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
