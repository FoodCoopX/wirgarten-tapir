...
export class WaitingListApi extends runtime.BaseAPI {
    ...
    /**
     */
    async waitingListApiPublicWaitingListCreateEntryNewMemberCreateRaw(requestParameters: WaitingListApiPublicWaitingListCreateEntryNewMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
    ...
    /**
     */
    async waitingListApiPublicWaitingListCreateEntryNewMemberCreate(requestParameters: WaitingListApiPublicWaitingListCreateEntryNewMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.waitingListApiPublicWaitingListCreateEntryNewMemberCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
