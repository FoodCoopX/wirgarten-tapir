...
import type {
  ...
  OptionalWaitingListEntryDetails,
...
import {
    CountsFromJSON,
    CountsToJSON,
    DisableLinkSerializerRequestFromJSON,
    DisableLinkSerializerRequestToJSON,
    OptionalWaitingListEntryDetailsFromJSON,
    OptionalWaitingListEntryDetailsToJSON,
    ...
    SendLinkSerializerRequestFromJSON,
...
export interface WaitingListApiMemberWaitingListEntryDetailsRetrieveRequest {
    memberId: string;
}
...
export interface WaitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRequest {
...
export class WaitingListApi extends runtime.BaseAPI {
    ...
    /**
     */
    async waitingListApiCountsRetrieveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Counts>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CountsFromJSON(jsonValue));
    }

    /**
     */
    async waitingListApiCountsRetrieve(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Counts> {
    ...
    /**
     */
    async waitingListApiDisableWaitingListLinkCreateRaw(requestParameters: WaitingListApiDisableWaitingListLinkCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: DisableLinkSerializerRequestToJSON(requestParameters['disableLinkSerializerRequest']),
        }, initOverrides);
    ...
    /**
     */
    async waitingListApiDisableWaitingListLinkCreate(requestParameters: WaitingListApiDisableWaitingListLinkCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.waitingListApiDisableWaitingListLinkCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async waitingListApiListListRaw(requestParameters: WaitingListApiListListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedWaitingListEntryDetailsList>> {
        ...
        if (requestParameters['currentPickupLocationId'] != null) {
            queryParameters['current_pickup_location_id'] = requestParameters['currentPickupLocationId'];
        }
        ...
        if (requestParameters['pickupLocationWish'] != null) {
            queryParameters['pickup_location_wish'] = requestParameters['pickupLocationWish'];
        }
    ...
    /**
     */
    async waitingListApiMemberWaitingListEntryDetailsRetrieveRaw(requestParameters: WaitingListApiMemberWaitingListEntryDetailsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OptionalWaitingListEntryDetails>> {
        if (requestParameters['memberId'] == null) {
            throw new runtime.RequiredError(
                'memberId',
                'Required parameter "memberId" was null or undefined when calling waitingListApiMemberWaitingListEntryDetailsRetrieve().'
            );
        }
        ...
        const response = await this.request({
            path: `/waiting_list/api/member_waiting_list_entry_details`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => OptionalWaitingListEntryDetailsFromJSON(jsonValue));
    }

    /**
     */
    async waitingListApiMemberWaitingListEntryDetailsRetrieve(requestParameters: WaitingListApiMemberWaitingListEntryDetailsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OptionalWaitingListEntryDetails> {
        const response = await this.waitingListApiMemberWaitingListEntryDetailsRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async waitingListApiPublicConfirmWaitingListEntryCreateRaw(requestParameters: WaitingListApiPublicConfirmWaitingListEntryCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        if (requestParameters['publicConfirmWaitingListEntryRequestRequest'] == null) {
            throw new runtime.RequiredError(
                'publicConfirmWaitingListEntryRequestRequest',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PublicConfirmWaitingListEntryRequestRequestToJSON(requestParameters['publicConfirmWaitingListEntryRequestRequest']),
        }, initOverrides);
    ...
    /**
     */
    async waitingListApiPublicConfirmWaitingListEntryCreate(requestParameters: WaitingListApiPublicConfirmWaitingListEntryCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.waitingListApiPublicConfirmWaitingListEntryCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async waitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRaw(requestParameters: WaitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        if (requestParameters['publicWaitingListEntryNewMemberCreateRequest'] == null) {
            throw new runtime.RequiredError(
                'publicWaitingListEntryNewMemberCreateRequest',
                'Required parameter "publicWaitingListEntryNewMemberCreateRequest" was null or undefined when calling waitingListApiPublicWaitingListCreateEntryPotentialMemberCreate().'
            );
        }
        ...
        const response = await this.request({
            path: `/waiting_list/api/public_waiting_list_create_entry_potential_member`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: PublicWaitingListEntryNewMemberCreateRequestToJSON(requestParameters['publicWaitingListEntryNewMemberCreateRequest']),
        }, initOverrides);
    ...
    /**
     */
    async waitingListApiPublicWaitingListCreateEntryPotentialMemberCreate(requestParameters: WaitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.waitingListApiPublicWaitingListCreateEntryPotentialMemberCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async waitingListApiSendWaitingListLinkCreateRaw(requestParameters: WaitingListApiSendWaitingListLinkCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SendLinkSerializerRequestToJSON(requestParameters['sendLinkSerializerRequest']),
        }, initOverrides);
    ...
    /**
     */
    async waitingListApiSendWaitingListLinkCreate(requestParameters: WaitingListApiSendWaitingListLinkCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.waitingListApiSendWaitingListLinkCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async waitingListApiShowCoopContentRetrieveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async waitingListApiShowCoopContentRetrieve(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean> {
        const response = await this.waitingListApiShowCoopContentRetrieveRaw(initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async waitingListApiWaitingListCreateEntryExistingMemberCreateRaw(requestParameters: WaitingListApiWaitingListCreateEntryExistingMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderConfirmationResponse>> {
        if (requestParameters['publicWaitingListEntryExistingMemberCreateRequest'] == null) {
            throw new runtime.RequiredError(
                'publicWaitingListEntryExistingMemberCreateRequest',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PublicWaitingListEntryExistingMemberCreateRequestToJSON(requestParameters['publicWaitingListEntryExistingMemberCreateRequest']),
        }, initOverrides);
    ...
    /**
     */
    async waitingListApiWaitingListCreateEntryExistingMemberCreate(requestParameters: WaitingListApiWaitingListCreateEntryExistingMemberCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderConfirmationResponse> {
        const response = await this.waitingListApiWaitingListCreateEntryExistingMemberCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
export type WaitingListApiListListEntryTypeEnum = typeof WaitingListApiListListEntryTypeEnum[keyof typeof WaitingListApiListListEntryTypeEnum];
/**
 * @export
 */
...
export type WaitingListApiListListMemberTypeEnum = typeof WaitingListApiListListMemberTypeEnum[keyof typeof WaitingListApiListListMemberTypeEnum];
/**
 * @export
 */
...
export type WaitingListApiListListOrderByEnum = typeof WaitingListApiListListOrderByEnum[keyof typeof WaitingListApiListListOrderByEnum];
