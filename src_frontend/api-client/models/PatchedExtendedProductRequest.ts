 ...
 */
export function instanceOfPatchedExtendedProductRequest(value: object): value is PatchedExtendedProductRequest {
    return true;
}

export function PatchedExtendedProductRequestFromJSON(json: any): PatchedExtendedProductRequest {
    return PatchedExtendedProductRequestFromJSONTyped(json, false);
}

export function PatchedExtendedProductRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedExtendedProductRequest {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PatchedExtendedProductRequestToJSON(json: any): PatchedExtendedProductRequest {
      return PatchedExtendedProductRequestToJSONTyped(json, false);
  }

  export function PatchedExtendedProductRequestToJSONTyped(value?: PatchedExtendedProductRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
