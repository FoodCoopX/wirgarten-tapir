...
export function MemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): Member {
    ...
    return {
        ...
        'phoneNumberLandline': json['phone_number_landline'] == null ? undefined : json['phone_number_landline'],
        ...
        'formOfAddress': json['form_of_address'] == null ? undefined : json['form_of_address'],
  ...
  export function MemberToJSONTyped(value?: Omit<Member, 'created_at'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'form_of_address': value['formOfAddress'],
