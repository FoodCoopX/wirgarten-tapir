...
export function instanceOfCancellationData(value: object): value is CancellationData {
    ...
    if (!('showTrialPeriodHelpText' in value) || value['showTrialPeriodHelpText'] === undefined) return false;
    if (!('trialPeriodDuration' in value) || value['trialPeriodDuration'] === undefined) return false;
    if (!('trialPeriodIsFlexible' in value) || value['trialPeriodIsFlexible'] === undefined) return false;
    return true;
}
