 ...
 */
export function instanceOfSubscriptionChangeLogEntry(
  value: object,
): value is SubscriptionChangeLogEntry {
  ...
  if (!("subscriptions" in value) || value["subscriptions"] === undefined)
    return false;
  if (!("logClassType" in value) || value["logClassType"] === undefined)
    return false;
  return true;
}

export function SubscriptionChangeLogEntryFromJSON(
  json: any,
): SubscriptionChangeLogEntry {
  return SubscriptionChangeLogEntryFromJSONTyped(json, false);
}

export function SubscriptionChangeLogEntryFromJSONTyped(
  json: any,
...
export function SubscriptionChangeLogEntryToJSON(
  json: any,
): SubscriptionChangeLogEntry {
  return SubscriptionChangeLogEntryToJSONTyped(json, false);
}

export function SubscriptionChangeLogEntryToJSONTyped(
  value?: Omit<SubscriptionChangeLogEntry, "id" | "created_date"> | null,
