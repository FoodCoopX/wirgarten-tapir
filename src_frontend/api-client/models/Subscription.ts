...
export interface Subscription {
   ...
   * @memberof Subscription
   */
  solidarityPricePercentage?: number | null;
  /**
   *
   * @type {string}
   * @memberof Subscription
...
export function SubscriptionFromJSONTyped(
  ...
  return {
    ...
    solidarityPricePercentage:
      json["solidarity_price_percentage"] == null
        ? undefined
        : json["solidarity_price_percentage"],
    solidarityPriceAbsolute:
      json["solidarity_price_absolute"] == null
        ? undefined
        : json["solidarity_price_absolute"],
    createdAt:
...
export function SubscriptionToJSONTyped(
  ...
  return {
    ...
    solidarity_price_percentage: value["solidarityPricePercentage"],
