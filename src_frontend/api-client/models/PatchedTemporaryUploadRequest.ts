 ...
 */
export function instanceOfPatchedTemporaryUploadRequest(
  value: object,
): value is PatchedTemporaryUploadRequest {
  return true;
}

export function PatchedTemporaryUploadRequestFromJSON(
  json: any,
): PatchedTemporaryUploadRequest {
  return PatchedTemporaryUploadRequestFromJSONTyped(json, false);
}

export function PatchedTemporaryUploadRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    uploadType:
      json["upload_type"] == null
        ? undefined
        : UploadTypeEnumFromJSON(json["upload_type"]),
    uploadedBy: json["uploaded_by"] == null ? undefined : json["uploaded_by"],
  };
}

export function PatchedTemporaryUploadRequestToJSON(
  json: any,
): PatchedTemporaryUploadRequest {
  return PatchedTemporaryUploadRequestToJSONTyped(json, false);
}

export function PatchedTemporaryUploadRequestToJSONTyped(
  value?: PatchedTemporaryUploadRequest | null,
