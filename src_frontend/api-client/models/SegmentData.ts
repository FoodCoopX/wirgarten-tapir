...
export function SegmentDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SegmentData {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function SegmentDataToJSONTyped(value?: SegmentData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
