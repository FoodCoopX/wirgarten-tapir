 ...
 */
export function instanceOfExtendedProductTypeAndConfig(
  value: object,
): value is ExtendedProductTypeAndConfig {
...
export function ExtendedProductTypeAndConfigFromJSON(
  json: any,
): ExtendedProductTypeAndConfig {
  return ExtendedProductTypeAndConfigFromJSONTyped(json, false);
}

export function ExtendedProductTypeAndConfigFromJSONTyped(
  json: any,
...
export function ExtendedProductTypeAndConfigToJSON(
  json: any,
): ExtendedProductTypeAndConfig {
  return ExtendedProductTypeAndConfigToJSONTyped(json, false);
}

export function ExtendedProductTypeAndConfigToJSONTyped(
  value?: ExtendedProductTypeAndConfig | null,
