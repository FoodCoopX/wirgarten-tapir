 ...
 */
export function instanceOfTriggerFieldDefinition(
  value: object,
): value is TriggerFieldDefinition {
...
export function TriggerFieldDefinitionFromJSON(
  json: any,
): TriggerFieldDefinition {
  return TriggerFieldDefinitionFromJSONTyped(json, false);
}

export function TriggerFieldDefinitionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    additionalData:
      json["additional_data"] == null ? undefined : json["additional_data"],
  };
}

export function TriggerFieldDefinitionToJSON(
  json: any,
): TriggerFieldDefinition {
  return TriggerFieldDefinitionToJSONTyped(json, false);
}

export function TriggerFieldDefinitionToJSONTyped(
  value?: TriggerFieldDefinition | null,
