 ...
 */
export function instanceOfEmailConfigurationDispatchRequest(
  value: object,
): value is EmailConfigurationDispatchRequest {
...
export function EmailConfigurationDispatchRequestFromJSON(
  json: any,
): EmailConfigurationDispatchRequest {
  return EmailConfigurationDispatchRequestFromJSONTyped(json, false);
}

export function EmailConfigurationDispatchRequestFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    emailConfigurationVersion: EmailConfigurationVersionRequestFromJSON(
...
export function EmailConfigurationDispatchRequestToJSON(
  json: any,
): EmailConfigurationDispatchRequest {
  return EmailConfigurationDispatchRequestToJSONTyped(json, false);
}

export function EmailConfigurationDispatchRequestToJSONTyped(
  value?: EmailConfigurationDispatchRequest | null,
