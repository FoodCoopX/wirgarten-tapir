 ...
 */
export function instanceOfExtendedProductTypeRequest(
  value: object,
): value is ExtendedProductTypeRequest {
  ...
  if (!("deliveryCycle" in value) || value["deliveryCycle"] === undefined)
    return false;
  if (!("taxRate" in value) || value["taxRate"] === undefined) return false;
  if (
    !("taxRateChangeDate" in value) ||
    value["taxRateChangeDate"] === undefined
  )
    return false;
  if (
    !("singleSubscriptionOnly" in value) ||
    value["singleSubscriptionOnly"] === undefined
  )
    return false;
  if (
    !("isAffectedByJokers" in value) ||
    value["isAffectedByJokers"] === undefined
  )
    return false;
  if (
  ...
  if (!("forceWaitingList" in value) || value["forceWaitingList"] === undefined)
    return false;
  if (
    !("accordionsInBestellWizard" in value) ||
    value["accordionsInBestellWizard"] === undefined
  )
    return false;
  if (
    !("titleBestellwizardProductChoice" in value) ||
    value["titleBestellwizardProductChoice"] === undefined
  )
    return false;
  if (
    !("titleBestellwizardIntro" in value) ||
    value["titleBestellwizardIntro"] === undefined
  )
    return false;
  if (
    !("backgroundImageInBestellwizard" in value) ||
    value["backgroundImageInBestellwizard"] === undefined
  )
    return false;
  if (
...
export function ExtendedProductTypeRequestFromJSON(
  json: any,
): ExtendedProductTypeRequest {
  return ExtendedProductTypeRequestFromJSONTyped(json, false);
}

export function ExtendedProductTypeRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    noticePeriodDuration:
      json["notice_period_duration"] == null
        ? undefined
        : json["notice_period_duration"],
    noticePeriodUnit:
      json["notice_period_unit"] == null
        ? undefined
        : NoticePeriodUnitEnumFromJSON(json["notice_period_unit"]),
    ...
    ).map(ProductTypeAccordionInBestellWizardRequestFromJSON),
...
export function ExtendedProductTypeRequestToJSON(
  json: any,
): ExtendedProductTypeRequest {
  return ExtendedProductTypeRequestToJSONTyped(json, false);
}

export function ExtendedProductTypeRequestToJSONTyped(
  value?: ExtendedProductTypeRequest | null,
  ...
  return {
    ...
    tax_rate_change_date: value["taxRateChangeDate"]
      .toISOString()
      .substring(0, 10),
    ...
    ).map(ProductTypeAccordionInBestellWizardRequestToJSON),
