...
export function PickupLocationOpeningTimeFromJSON(json: any): PickupLocationOpeningTime {
    return PickupLocationOpeningTimeFromJSONTyped(json, false);
}

export function PickupLocationOpeningTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupLocationOpeningTime {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PickupLocationOpeningTimeToJSON(json: any): PickupLocationOpeningTime {
