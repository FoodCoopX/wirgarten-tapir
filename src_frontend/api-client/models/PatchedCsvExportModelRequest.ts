 ...
 */
export function instanceOfPatchedCsvExportModelRequest(
  value: object,
): value is PatchedCsvExportModelRequest {
  return true;
}

export function PatchedCsvExportModelRequestFromJSON(
  json: any,
): PatchedCsvExportModelRequest {
  return PatchedCsvExportModelRequestFromJSONTyped(json, false);
}

export function PatchedCsvExportModelRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    locale:
      json["locale"] == null ? undefined : LocaleEnumFromJSON(json["locale"]),
  };
}

export function PatchedCsvExportModelRequestToJSON(
  json: any,
): PatchedCsvExportModelRequest {
  return PatchedCsvExportModelRequestToJSONTyped(json, false);
}

export function PatchedCsvExportModelRequestToJSONTyped(
  value?: PatchedCsvExportModelRequest | null,
