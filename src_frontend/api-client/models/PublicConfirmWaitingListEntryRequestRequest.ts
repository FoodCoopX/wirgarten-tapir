...
export function PublicConfirmWaitingListEntryRequestRequestFromJSON(json: any): PublicConfirmWaitingListEntryRequestRequest {
    return PublicConfirmWaitingListEntryRequestRequestFromJSONTyped(json, false);
}

export function PublicConfirmWaitingListEntryRequestRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicConfirmWaitingListEntryRequestRequest {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PublicConfirmWaitingListEntryRequestRequestToJSON(json: any): PublicConfirmWaitingListEntryRequestRequest {
      return PublicConfirmWaitingListEntryRequestRequestToJSONTyped(json, false);
  }

  export function PublicConfirmWaitingListEntryRequestRequestToJSONTyped(value?: PublicConfirmWaitingListEntryRequestRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
