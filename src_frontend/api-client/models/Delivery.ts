...
export function instanceOfDelivery(value: object): value is Delivery {
  ...
  if (!("subscriptions" in value) || value["subscriptions"] === undefined)
    return false;
  if (
    !("pickupLocationOpeningTimes" in value) ||
    value["pickupLocationOpeningTimes"] === undefined
  )
    return false;
  if (!("jokerUsed" in value) || value["jokerUsed"] === undefined) return false;
  if (!("canJokerBeUsed" in value) || value["canJokerBeUsed"] === undefined)
    return false;
  if (
    !("canJokerBeUsedRelativeToDateLimit" in value) ||
    value["canJokerBeUsedRelativeToDateLimit"] === undefined
  )
    return false;
  if (
    !("isDeliveryCancelledThisWeek" in value) ||
    value["isDeliveryCancelledThisWeek"] === undefined
  )
    return false;
  if (!("donationUsed" in value) || value["donationUsed"] === undefined)
    return false;
  if (
    !("canDeliveryBeDonated" in value) ||
    value["canDeliveryBeDonated"] === undefined
  )
    return false;
  return true;
}
...
export function DeliveryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    pickupLocationOpeningTimes: (
      json["pickup_location_opening_times"] as Array<any>
    ).map(PickupLocationOpeningTimeFromJSON),
    jokerUsed: json["joker_used"],
    canJokerBeUsed: json["can_joker_be_used"],
    canJokerBeUsedRelativeToDateLimit:
      json["can_joker_be_used_relative_to_date_limit"],
...
export function DeliveryToJSONTyped(
  value?: Delivery | null,
  ...
  return {
    ...
    pickup_location_opening_times: (
      value["pickupLocationOpeningTimes"] as Array<any>
    ).map(PickupLocationOpeningTimeToJSON),
    joker_used: value["jokerUsed"],
    can_joker_be_used: value["canJokerBeUsed"],
    can_joker_be_used_relative_to_date_limit:
      value["canJokerBeUsedRelativeToDateLimit"],
