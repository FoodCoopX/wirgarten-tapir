...
export function instanceOfProductForCancellation(value: object): value is ProductForCancellation {
    ...
    if (!('lastDayOfNoticePeriod' in value) || value['lastDayOfNoticePeriod'] === undefined) return false;
    if (!('dateLimitForTrialCancellation' in value) || value['dateLimitForTrialCancellation'] === undefined) return false;
    ...
    if (!('subscriptionEndDate' in value) || value['subscriptionEndDate'] === undefined) return false;
    return true;
}
...
export function ProductForCancellationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductForCancellation {
    ...
    return {
        ...
        'dateLimitForTrialCancellation': (new Date(json['date_limit_for_trial_cancellation'])),
  ...
  export function ProductForCancellationToJSONTyped(value?: Omit<ProductForCancellation, 'product'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'last_day_of_notice_period': ((value['lastDayOfNoticePeriod']).toISOString().substring(0,10)),
        'date_limit_for_trial_cancellation': ((value['dateLimitForTrialCancellation']).toISOString().substring(0,10)),
        'notice_period_duration': value['noticePeriodDuration'],
        'notice_period_unit': NoticePeriodUnitEnumToJSON(value['noticePeriodUnit']),
        'subscription_end_date': ((value['subscriptionEndDate']).toISOString().substring(0,10)),
    };
}
