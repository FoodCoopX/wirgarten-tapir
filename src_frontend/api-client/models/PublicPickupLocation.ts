 ...
 */
export function instanceOfPublicPickupLocation(value: object): value is PublicPickupLocation {
...
export function PublicPickupLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicPickupLocation {
    if (json == null) {
        return json;
    }
    return {
