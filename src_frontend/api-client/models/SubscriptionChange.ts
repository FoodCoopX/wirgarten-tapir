 ...
 */
export function instanceOfSubscriptionChange(value: object): value is SubscriptionChange {
...
export function SubscriptionChangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriptionChange {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function SubscriptionChangeToJSONTyped(value?: SubscriptionChange | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
