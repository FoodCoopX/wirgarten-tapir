 ...
 */
export function instanceOfTemporaryUpload(value: object): value is TemporaryUpload {
...
export function TemporaryUploadFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemporaryUpload {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function TemporaryUploadToJSONTyped(value?: Omit<TemporaryUpload, 'uploaded'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
