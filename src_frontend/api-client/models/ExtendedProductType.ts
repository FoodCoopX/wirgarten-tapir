 ...
 */
export function instanceOfExtendedProductType(
  value: object,
): value is ExtendedProductType {
...
export function ExtendedProductTypeFromJSONTyped(
  json: any,
  ...
  return {
    ...
    ).map(ProductTypeAccordionInBestellWizardFromJSON),
...
export function ExtendedProductTypeToJSONTyped(
  value?: ExtendedProductType | null,
  ...
  return {
    ...
    ).map(ProductTypeAccordionInBestellWizardToJSON),
