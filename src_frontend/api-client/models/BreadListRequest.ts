 ...
 */
export function instanceOfBreadListRequest(
  value: object,
): value is BreadListRequest {
...
export function BreadListRequestFromJSONTyped(
  json: any,
...
export function BreadListRequestToJSONTyped(
  value?: BreadListRequest | null,
