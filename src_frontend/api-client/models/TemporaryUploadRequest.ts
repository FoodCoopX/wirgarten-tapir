 ...
 */
export function instanceOfTemporaryUploadRequest(
  value: object,
): value is TemporaryUploadRequest {
...
export function TemporaryUploadRequestFromJSON(
  json: any,
): TemporaryUploadRequest {
  return TemporaryUploadRequestFromJSONTyped(json, false);
}

export function TemporaryUploadRequestFromJSONTyped(
  json: any,
...
export function TemporaryUploadRequestToJSON(
  json: any,
): TemporaryUploadRequest {
  return TemporaryUploadRequestToJSONTyped(json, false);
}

export function TemporaryUploadRequestToJSONTyped(
  value?: TemporaryUploadRequest | null,
