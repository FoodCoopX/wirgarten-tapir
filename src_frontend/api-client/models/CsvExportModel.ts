 ...
 */
export function instanceOfCsvExportModel(
  value: object,
): value is CsvExportModel {
...
export function CsvExportModelFromJSONTyped(
  json: any,
...
export function CsvExportModelToJSONTyped(
  value?: CsvExportModel | null,
