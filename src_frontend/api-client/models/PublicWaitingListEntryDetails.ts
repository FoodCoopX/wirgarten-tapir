 ...
 */
export function instanceOfPublicWaitingListEntryDetails(value: object): value is PublicWaitingListEntryDetails {
...
export function PublicWaitingListEntryDetailsFromJSON(json: any): PublicWaitingListEntryDetails {
    return PublicWaitingListEntryDetailsFromJSONTyped(json, false);
}

export function PublicWaitingListEntryDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicWaitingListEntryDetails {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pickupLocationWishes': json['pickup_location_wishes'] == null ? undefined : ((json['pickup_location_wishes'] as Array<any>).map(PublicPickupLocationFromJSON)),
        'productWishes': json['product_wishes'] == null ? undefined : ((json['product_wishes'] as Array<any>).map(PublicWaitingListProductWishFromJSON)),
        'numberOfCoopShares': json['number_of_coop_shares'],
        'paymentRhythm': json['payment_rhythm'] == null ? undefined : json['payment_rhythm'],
    };
}

  export function PublicWaitingListEntryDetailsToJSON(json: any): PublicWaitingListEntryDetails {
      return PublicWaitingListEntryDetailsToJSONTyped(json, false);
  }

  export function PublicWaitingListEntryDetailsToJSONTyped(value?: PublicWaitingListEntryDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'iban': value['iban'],
        'pickup_location_wishes': value['pickupLocationWishes'] == null ? undefined : ((value['pickupLocationWishes'] as Array<any>).map(PublicPickupLocationToJSON)),
        'product_wishes': value['productWishes'] == null ? undefined : ((value['productWishes'] as Array<any>).map(PublicWaitingListProductWishToJSON)),
