 ...
 */
export function instanceOfPatchedBreadListRequest(
  value: object,
): value is PatchedBreadListRequest {
  return true;
}

export function PatchedBreadListRequestFromJSON(
  json: any,
): PatchedBreadListRequest {
  return PatchedBreadListRequestFromJSONTyped(json, false);
}

export function PatchedBreadListRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    piecesPerStoveLayer:
      json["pieces_per_stove_layer"] == null
        ? undefined
        : json["pieces_per_stove_layer"],
    oneBatchCanBeBakedInMoreThanOneStove:
      json["one_batch_can_be_baked_in_more_than_one_stove"] == null
        ? undefined
        : json["one_batch_can_be_baked_in_more_than_one_stove"],
...
export function PatchedBreadListRequestToJSON(
  json: any,
): PatchedBreadListRequest {
  return PatchedBreadListRequestToJSONTyped(json, false);
}

export function PatchedBreadListRequestToJSONTyped(
  value?: PatchedBreadListRequest | null,
  ...
  return {
    ...
    one_batch_can_be_baked_in_more_than_one_stove:
      value["oneBatchCanBeBakedInMoreThanOneStove"],
