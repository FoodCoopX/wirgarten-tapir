 ...
 */
export function instanceOfPaginatedEmailTemplateList(value: object): value is PaginatedEmailTemplateList {
    if (!('count' in value) || value['count'] === undefined) return false;
    if (!('results' in value) || value['results'] === undefined) return false;
    return true;
}

export function PaginatedEmailTemplateListFromJSON(json: any): PaginatedEmailTemplateList {
    return PaginatedEmailTemplateListFromJSONTyped(json, false);
}

export function PaginatedEmailTemplateListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginatedEmailTemplateList {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PaginatedEmailTemplateListToJSON(json: any): PaginatedEmailTemplateList {
      return PaginatedEmailTemplateListToJSONTyped(json, false);
  }

  export function PaginatedEmailTemplateListToJSONTyped(value?: PaginatedEmailTemplateList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
