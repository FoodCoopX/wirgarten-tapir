 ...
 */
export function instanceOfPickupLocationCapacityByShare(
  value: object,
): value is PickupLocationCapacityByShare {
...
export function PickupLocationCapacityByShareFromJSON(
  json: any,
): PickupLocationCapacityByShare {
  return PickupLocationCapacityByShareFromJSONTyped(json, false);
}

export function PickupLocationCapacityByShareFromJSONTyped(
  json: any,
...
export function PickupLocationCapacityByShareToJSON(
  json: any,
): PickupLocationCapacityByShare {
  return PickupLocationCapacityByShareToJSONTyped(json, false);
}

export function PickupLocationCapacityByShareToJSONTyped(
  value?: PickupLocationCapacityByShare | null,
