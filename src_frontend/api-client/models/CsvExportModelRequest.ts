 ...
 */
export function instanceOfCsvExportModelRequest(
  value: object,
): value is CsvExportModelRequest {
...
export function CsvExportModelRequestFromJSON(
  json: any,
): CsvExportModelRequest {
  return CsvExportModelRequestFromJSONTyped(json, false);
}

export function CsvExportModelRequestFromJSONTyped(
  json: any,
...
export function CsvExportModelRequestToJSONTyped(
  value?: CsvExportModelRequest | null,
