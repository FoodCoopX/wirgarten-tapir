...
export function instanceOfCoopShareTransaction(
  ...
  if (!("sharePrice" in value) || value["sharePrice"] === undefined)
    return false;
...
export function CoopShareTransactionFromJSONTyped(
  ...
  return {
    ...
    transferMember:
      json["transfer_member"] == null ? undefined : json["transfer_member"],
...
export function CoopShareTransactionToJSONTyped(
  value?: Omit<CoopShareTransaction, "created_at" | "updated_at"> | null,
