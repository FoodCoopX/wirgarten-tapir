 ...
 */
export function instanceOfTriggerDefinition(
  value: object,
): value is TriggerDefinition {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("fieldDefinitions" in value) || value["fieldDefinitions"] === undefined)
    return false;
  return true;
}
...
export function TriggerDefinitionFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    name: json["name"],
    fieldDefinitions: (json["field_definitions"] as Array<any>).map(
      TriggerFieldDefinitionFromJSON,
    ),
  };
}
...
export function TriggerDefinitionToJSONTyped(
  value?: TriggerDefinition | null,
  ...
  return {
    id: value["id"],
    name: value["name"],
    field_definitions: (value["fieldDefinitions"] as Array<any>).map(
      TriggerFieldDefinitionToJSON,
    ),
  };
}
