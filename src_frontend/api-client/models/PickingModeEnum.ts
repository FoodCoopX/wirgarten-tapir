...
export type PickingModeEnum =
  (typeof PickingModeEnum)[keyof typeof PickingModeEnum];
...
export function PickingModeEnumFromJSONTyped(
  json: any,
...
export function PickingModeEnumToJSONTyped(
  value: any,
  ignoreDiscriminator: boolean,
): PickingModeEnum {
