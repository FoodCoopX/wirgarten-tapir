 ...
 */
export function instanceOfPatchedPdfExportModelRequest(value: object): value is PatchedPdfExportModelRequest {
    return true;
}

export function PatchedPdfExportModelRequestFromJSON(json: any): PatchedPdfExportModelRequest {
    return PatchedPdfExportModelRequestFromJSONTyped(json, false);
}

export function PatchedPdfExportModelRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedPdfExportModelRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'generateOneFileForEverySegmentEntry': json['generate_one_file_for_every_segment_entry'] == null ? undefined : json['generate_one_file_for_every_segment_entry'],
    };
}

  export function PatchedPdfExportModelRequestToJSON(json: any): PatchedPdfExportModelRequest {
      return PatchedPdfExportModelRequestToJSONTyped(json, false);
  }

  export function PatchedPdfExportModelRequestToJSONTyped(value?: PatchedPdfExportModelRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
