 ...
 */
export function instanceOfBreadsPerPickupLocationPerWeek(
  value: object,
): value is BreadsPerPickupLocationPerWeek {
...
export function BreadsPerPickupLocationPerWeekFromJSON(
  json: any,
): BreadsPerPickupLocationPerWeek {
  return BreadsPerPickupLocationPerWeekFromJSONTyped(json, false);
}

export function BreadsPerPickupLocationPerWeekFromJSONTyped(
  json: any,
...
export function BreadsPerPickupLocationPerWeekToJSON(
  json: any,
): BreadsPerPickupLocationPerWeek {
  return BreadsPerPickupLocationPerWeekToJSONTyped(json, false);
}

export function BreadsPerPickupLocationPerWeekToJSONTyped(
  value?: Omit<
    BreadsPerPickupLocationPerWeek,
    | "id"
    | "bread_name"
