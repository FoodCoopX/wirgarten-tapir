 ...
 */
export function instanceOfBundledEmailConfiguration(value: object): value is BundledEmailConfiguration {
...
export function BundledEmailConfigurationFromJSON(json: any): BundledEmailConfiguration {
    return BundledEmailConfigurationFromJSONTyped(json, false);
}

export function BundledEmailConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BundledEmailConfiguration {
    if (json == null) {
        return json;
    }
    return {
        ...
        'segmentData': json['segment_data'] == null ? undefined : SegmentDataFromJSON(json['segment_data']),
    };
}

  export function BundledEmailConfigurationToJSON(json: any): BundledEmailConfiguration {
      return BundledEmailConfigurationToJSONTyped(json, false);
  }

  export function BundledEmailConfigurationToJSONTyped(value?: BundledEmailConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
