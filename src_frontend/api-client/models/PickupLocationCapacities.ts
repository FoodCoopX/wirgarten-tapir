...
export function instanceOfPickupLocationCapacities(
  ...
  if (
    ...
    return false;
  if (
    !("capacitiesByShares" in value) ||
    value["capacitiesByShares"] === undefined
  )
    return false;
  return true;
}
...
export function PickupLocationCapacitiesFromJSONTyped(
  ...
  return {
    ...
    capacitiesByShares: (json["capacities_by_shares"] as Array<any>).map(
      PickupLocationCapacityByShareFromJSON,
    ),
  };
}
...
export function PickupLocationCapacitiesToJSONTyped(
  ...
  return {
    ...
    capacities_by_shares: (value["capacitiesByShares"] as Array<any>).map(
      PickupLocationCapacityByShareToJSON,
    ),
  };
}
