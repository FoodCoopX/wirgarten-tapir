...
export function instanceOfPublicProductType(value: object): value is PublicProductType {
    ...
    if (!('pricePerDelivery' in value) || value['pricePerDelivery'] === undefined) return false;
    return true;
}
...
export function PublicProductTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicProductType {
  ...
  export function PublicProductTypeToJSONTyped(value?: Omit<PublicProductType, 'products'|'no_delivery'|'accordions'|'price_per_delivery'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
