 ...
 */
export function instanceOfWaitingListEntryUpdateRequest(
  value: object,
): value is WaitingListEntryUpdateRequest {
...
export function WaitingListEntryUpdateRequestFromJSON(
  json: any,
): WaitingListEntryUpdateRequest {
  return WaitingListEntryUpdateRequestFromJSONTyped(json, false);
}

export function WaitingListEntryUpdateRequestFromJSONTyped(
  json: any,
...
export function WaitingListEntryUpdateRequestToJSON(
  json: any,
): WaitingListEntryUpdateRequest {
  return WaitingListEntryUpdateRequestToJSONTyped(json, false);
}

export function WaitingListEntryUpdateRequestToJSONTyped(
  value?: WaitingListEntryUpdateRequest | null,
