 ...
 */
export function instanceOfPaginatedEmailDispatchList(value: object): value is PaginatedEmailDispatchList {
    if (!('count' in value) || value['count'] === undefined) return false;
    if (!('results' in value) || value['results'] === undefined) return false;
    return true;
}

export function PaginatedEmailDispatchListFromJSON(json: any): PaginatedEmailDispatchList {
    return PaginatedEmailDispatchListFromJSONTyped(json, false);
}

export function PaginatedEmailDispatchListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginatedEmailDispatchList {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PaginatedEmailDispatchListToJSON(json: any): PaginatedEmailDispatchList {
      return PaginatedEmailDispatchListToJSONTyped(json, false);
  }

  export function PaginatedEmailDispatchListToJSONTyped(value?: PaginatedEmailDispatchList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
