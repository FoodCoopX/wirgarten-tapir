 ...
 */
export function instanceOfEmailConfigurationVersion(
  value: object,
): value is EmailConfigurationVersion {
  if (
...
export function EmailConfigurationVersionFromJSON(
  json: any,
): EmailConfigurationVersion {
  return EmailConfigurationVersionFromJSONTyped(json, false);
}

export function EmailConfigurationVersionFromJSONTyped(
  json: any,
...
export function EmailConfigurationVersionToJSON(
  json: any,
): EmailConfigurationVersion {
  return EmailConfigurationVersionToJSONTyped(json, false);
}

export function EmailConfigurationVersionToJSONTyped(
  value?: Omit<
    EmailConfigurationVersion,
