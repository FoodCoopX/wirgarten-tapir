...
export type BounceTypeEnum =
  (typeof BounceTypeEnum)[keyof typeof BounceTypeEnum];
...
export function BounceTypeEnumFromJSONTyped(
  json: any,
...
export function BounceTypeEnumToJSONTyped(
  value: any,
  ignoreDiscriminator: boolean,
): BounceTypeEnum {
