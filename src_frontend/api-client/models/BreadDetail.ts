...
import { BreadContentFromJSON } from "./BreadContent";
...
export function instanceOfBreadDetail(value: object): value is BreadDetail {
  ...
  if (!("labelNames" in value) || value["labelNames"] === undefined)
    return false;
  if (!("contents" in value) || value["contents"] === undefined) return false;
  if (!("capacity" in value) || value["capacity"] === undefined) return false;
  if (!("deliveryCount" in value) || value["deliveryCount"] === undefined)
    return false;
  if (
    !("availableCapacity" in value) ||
...
export function BreadDetailFromJSONTyped(
  json: any,
...
export function BreadDetailToJSONTyped(
  value?: Omit<
    BreadDetail,
    | "id"
    | "labels"
