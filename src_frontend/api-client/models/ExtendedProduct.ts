 ...
 */
export function instanceOfExtendedProduct(
  value: object,
): value is ExtendedProduct {
  ...
  if (
    !("basketSizeEquivalences" in value) ||
    value["basketSizeEquivalences"] === undefined
  )
    return false;
...
export function ExtendedProductFromJSONTyped(
  json: any,
  ...
  return {
    ...
    basketSizeEquivalences: (
      json["basket_size_equivalences"] as Array<any>
    ).map(ProductBasketSizeEquivalenceFromJSON),
    growingPeriodId:
...
export function ExtendedProductToJSONTyped(
  ...
  return {
    ...
    basket_size_equivalences: (
      value["basketSizeEquivalences"] as Array<any>
