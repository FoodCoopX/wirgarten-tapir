...
export function instanceOfMemberJokerInformation(
  ...
  if (!("usedJokers" in value) || value["usedJokers"] === undefined)
    return false;
  if (
    !("maxJokersPerGrowingPeriod" in value) ||
    value["maxJokersPerGrowingPeriod"] === undefined
  )
    return false;
  if (!("weekdayLimit" in value) || value["weekdayLimit"] === undefined)
    return false;
  if (
    !("jokerRestrictions" in value) ||
    value["jokerRestrictions"] === undefined
  )
    return false;
  if (
...
export function MemberJokerInformationFromJSONTyped(
  ...
  return {
    ...
    jokerRestrictions: (json["joker_restrictions"] as Array<any>).map(
      JokerRestrictionFromJSON,
    ),
...
export function MemberJokerInformationToJSONTyped(
  ...
  return {
    ...
    joker_restrictions: (value["jokerRestrictions"] as Array<any>).map(
      JokerRestrictionToJSON,
    ),
