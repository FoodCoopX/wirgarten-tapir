 ...
 */
export function instanceOfPaginatedEmailConfigurationList(
  value: object,
): value is PaginatedEmailConfigurationList {
  if (!("count" in value) || value["count"] === undefined) return false;
  if (!("results" in value) || value["results"] === undefined) return false;
  return true;
}

export function PaginatedEmailConfigurationListFromJSON(
  json: any,
): PaginatedEmailConfigurationList {
  return PaginatedEmailConfigurationListFromJSONTyped(json, false);
}

export function PaginatedEmailConfigurationListFromJSONTyped(
  json: any,
...
export function PaginatedEmailConfigurationListToJSON(
  json: any,
): PaginatedEmailConfigurationList {
  return PaginatedEmailConfigurationListToJSONTyped(json, false);
}

export function PaginatedEmailConfigurationListToJSONTyped(
  value?: PaginatedEmailConfigurationList | null,
