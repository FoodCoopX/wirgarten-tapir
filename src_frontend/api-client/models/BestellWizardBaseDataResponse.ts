...
import {
    ...
    SolidarityStepPositionEnumFromJSONTyped,
    SolidarityStepPositionEnumToJSON,
    SolidarityStepPositionEnumToJSONTyped,
...
import {
    ...
    BestellWizardImagesFromJSONTyped,
    BestellWizardImagesToJSON,
    BestellWizardImagesToJSONTyped,
...
export function instanceOfBestellWizardBaseDataResponse(value: object): value is BestellWizardBaseDataResponse {
    ...
    if (!('solidarityStepPosition' in value) || value['solidarityStepPosition'] === undefined) return false;
...
export function BestellWizardBaseDataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BestellWizardBaseDataResponse {
    ...
    return {
        ...
        'pickupLocations': ((json['pickup_locations'] as Array<any>).map(PublicPickupLocationFromJSON)),
        ...
        'solidarityStepPosition': SolidarityStepPositionEnumFromJSON(json['solidarity_step_position']),
  ...
  export function BestellWizardBaseDataResponseToJSONTyped(value?: BestellWizardBaseDataResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'pickup_locations': ((value['pickupLocations'] as Array<any>).map(PublicPickupLocationToJSON)),
        ...
        'solidarity_step_position': SolidarityStepPositionEnumToJSON(value['solidarityStepPosition']),
