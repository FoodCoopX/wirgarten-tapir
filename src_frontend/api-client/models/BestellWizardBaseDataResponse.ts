...
export interface BestellWizardBaseDataResponse {
   ...
   * @memberof BestellWizardBaseDataResponse
   */
  solidarityContributionChoices: Array<string>;
  /**
   *
   * @type {number}
   * @memberof BestellWizardBaseDataResponse
...
export function instanceOfBestellWizardBaseDataResponse(
  ...
  if (
    ...
    return false;
  if (
    !("solidarityContributionChoices" in value) ||
    value["solidarityContributionChoices"] === undefined
  )
    return false;
  if (
    !("solidarityContributionMinimum" in value) ||
    value["solidarityContributionMinimum"] === undefined
  )
    return false;
  if (
    !("solidarityContributionDefault" in value) ||
    value["solidarityContributionDefault"] === undefined
  )
    return false;
  if (
    !("feedbackStepEnabled" in value) ||
    value["feedbackStepEnabled"] === undefined
  )
    return false;
  if (
    !("growingPeriodChoices" in value) ||
    value["growingPeriodChoices"] === undefined
  )
    return false;
  if (
    !("solidarityStepPosition" in value) ||
...
export function BestellWizardBaseDataResponseFromJSONTyped(
  ...
  return {
    ...
    growingPeriodChoices: (json["growing_period_choices"] as Array<any>).map(
      PublicGrowingPeriodFromJSON,
    ),
...
export function BestellWizardBaseDataResponseToJSONTyped(
  ...
  return {
    ...
    growing_period_choices: (value["growingPeriodChoices"] as Array<any>).map(
      PublicGrowingPeriodToJSON,
    ),
