...
import {
    ...
    SubscriptionChangeLogEntryFromJSONTyped,
    SubscriptionChangeLogEntryToJSON,
    SubscriptionChangeLogEntryToJSONTyped,
...
export function instanceOfMemberDataToConfirm(value: object): value is MemberDataToConfirm {
    ...
    if (!('memberProfileUrl' in value) || value['memberProfileUrl'] === undefined) return false;
