...
export interface MemberDataToConfirm {
   ...
   * @memberof MemberDataToConfirm
   */
  sharePurchases: Array<CoopShareTransaction>;
}
...
export function instanceOfMemberDataToConfirm(
  ...
  if (
    ...
    return false;
  if (
    !("subscriptionsDeleted" in value) ||
    value["subscriptionsDeleted"] === undefined
  )
    return false;
  ...
  if (
    ...
    return false;
  if (!("sharePurchases" in value) || value["sharePurchases"] === undefined)
    return false;
  return true;
}
...
export function MemberDataToConfirmFromJSONTyped(
  ...
  return {
    ...
    subscriptionsDeleted: (json["subscriptions_deleted"] as Array<any>).map(
      SubscriptionChangeLogEntryFromJSON,
    ),
    showWarning: json["show_warning"],
    cancellationTypes: json["cancellation_types"],
    sharePurchases: (json["share_purchases"] as Array<any>).map(
      CoopShareTransactionFromJSON,
    ),
  };
}
...
export function MemberDataToConfirmToJSONTyped(
  ...
  return {
    ...
    subscriptions_deleted: (value["subscriptionsDeleted"] as Array<any>).map(
      SubscriptionChangeLogEntryToJSON,
    ),
    show_warning: value["showWarning"],
    cancellation_types: value["cancellationTypes"],
    share_purchases: (value["sharePurchases"] as Array<any>).map(
      CoopShareTransactionToJSON,
    ),
  };
}
