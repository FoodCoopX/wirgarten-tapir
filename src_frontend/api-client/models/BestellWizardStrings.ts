...
export function instanceOfBestellWizardStrings(value: object): value is BestellWizardStrings {
    ...
    if (!('step10FlagStudent' in value) || value['step10FlagStudent'] === undefined) return false;
    if (!('step10TextStudent' in value) || value['step10TextStudent'] === undefined) return false;
    ...
    if (!('studentCheckboxExplanationText' in value) || value['studentCheckboxExplanationText'] === undefined) return false;
    return true;
}
