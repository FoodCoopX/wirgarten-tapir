...
export function instanceOfBestellWizardConfirmOrderRequestRequest(
  ...
  if (
    !("shoppingCartOrder" in value) ||
    value["shoppingCartOrder"] === undefined
  )
    return false;
  if (
    !("shoppingCartWaitingList" in value) ||
    value["shoppingCartWaitingList"] === undefined
  )
    return false;
  ...
  if (!("paymentRhythm" in value) || value["paymentRhythm"] === undefined)
    return false;
  if (!("becomeMemberNow" in value) || value["becomeMemberNow"] === undefined)
    return false;
  if (
    !("privacyPolicyRead" in value) ||
    value["privacyPolicyRead"] === undefined
  )
    return false;
  if (
