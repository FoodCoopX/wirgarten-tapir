    ...
    <>
      <Alert variant={"warning"}>
        <p className={"mb-2"}>
          ...
          weiterhin in beiden Dateien, aber mit leerem IBAN-Feld. Die CSV-Datei
          ist somit weiterhin nutzbar in einem weiterführenden Schritt (z.B.
        ...
        <p className={"mb-0"}>
          Bitte ergänzt die IBAN, bevor ihr die Dateien neu erzeugt und dann im
          Online-Banking hochladet.
        </p>
      </Alert>
